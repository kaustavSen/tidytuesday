...
avatar %>% 
  ...
  geom_text(data = mean_ratings_by_book,
            ...
            alpha = 0.5,
            family = font) +
  annotate("text", x = 2.6, y = 7, 
           label = "Gets interesting as we \nprogress through the chapters",
           family = font,
           size = 3) +
  ...
  labs(title = "Avatar: The Last Airbender",
       subtitle = "How do the ratings change as we progress through the chapters?",
       x = "",
       y = "IMDB Rating") +
  theme_avatar() +
  theme(legend.background = element_blank(),
        ...
        panel.grid.minor.y = element_line(linetype = "dashed",
                                    size = 0.5,
                                    color = "#c7c45e")) +
  ggsave("plots/week_33.png", height = 6, width = 6, type = "cairo")
```
