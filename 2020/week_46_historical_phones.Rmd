...
p1 <- ggplot(subs) +
  ...
  geom_richtext(data = tibble(x = 0.5, y = 3.5, year = 2000), aes(x = x, y = y), hjust = 0, fill = NA, label.color = NA, size = 8, lineheight = 1.25, family = "body_font", label = "At the start of the century had we randomly<br>surveyed 100 people in the world, we would have<br>got 17 phone subscriptions amongst them") +
  ...
  geom_richtext(data = tibble(x = 0.5, y = 14.25, year = 2017), aes(x = x, y = y), hjust = 0, fill = NA, label.color = NA, size = 8, lineheight = 1.25, family = "body_font", label = "A similar experiment at 2017 would have resulted<br>in 128 subscriptions amongst the 100 surveyed") +
  ...
  # ggsave("temp.pdf", height = 15, width = 15, device = cairo_pdf)
```
